...
class Details extends React.Component {
    ...
    async componentDidMount() {
        ...
        console.log(res.data[this.state.selectedCollection].cards);
        this.setState({
            currentCollection: res.data[this.state.selectedCollection].title,
            cards: res.data[this.state.selectedCollection].cards,
            numOfCards: res.data[this.state.selectedCollection].cards.length,
            currentCardNumber: 1,
            currentCard: res.data[this.state.selectedCollection].cards[this.state.currentCardNumber],
            cardDisplay: res.data[this.state.selectedCollection].cards[this.state.currentCardNumber].word
        });
